      ...
      <section className="flex flex-col items-center justify-center snap-y pt-8">
        <div className="flex flex-col rounded-lg shadow-lg pt-4 bg-transparent">
          ...
          <div className="flex justify-between p-4">
            <div className=" flex flex-col object-center">
                ...
                <h2 className="text-slate-900 dark:text-slate-100 font-semibold text-xl">Número de contacto: <span className="text-green-800 dark:text-green-400">7689-4785</span></h2>
                <h2 className="text-slate-900 dark:text-slate-100 font-semibold text-xl">Correo Electronico: <span className="text-green-800 dark:text-green-400">dummytest@test.com</span></h2>
            </div>
        ...
        <div className="flex flex-col rounded-lg shadow-lg pt-8 sm:w-5/12 w-6/12 bg-transparent">
          ...
          <div className="flex justify-between p-4 w-auto h-auto">
            <div className=" flex flex-col object-center">
                <p className="text-slate-700 dark:text-slate-300 text-justify">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec at nulla quis dui rutrum porta. Aliquam erat volutpat. Nulla eu dignissim leo, non eleifend justo. Vestibulum arcu metus, mollis bibendum blandit id, laoreet ac ipsum. Aenean interdum lacinia molestie. Fusce sollicitudin congue varius. In in nunc augue. Nulla facilisi. Nullam efficitur lobortis ipsum. Etiam tempor vel magna vitae varius. Sed faucibus arcu augue, nec molestie sapien fringilla id.</p>
            </div>
          </div>
        </div>
      </section>
