    ...
    <main className="min-h-screen bg-gradient-to-b from-white to-slate-50 p-6">
      <section className="max-w-5xl mx-auto">
        <header className="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <h1 className="text-2xl font-extrabold text-slate-900">Solicitudes recibidas</h1>
            <p className="text-sm text-slate-500">Historial de solicitudes rechazadas o canceladas.</p>
          </div>

          <div className="flex gap-2">
            <Link to="/contratist-page/requests/pending" className="px-4 py-2 rounded-md bg-white border text-sm">Pendientes</Link>
        ...
        <div className="grid gap-6">
          <SolicitudRow
            ...
            estado="Cancelado"
          />
          {/* mapear aquí las solicitudes reales */}
        </div>
      </section>
    </main>
  );
